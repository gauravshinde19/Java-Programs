/*
    Program to accept number of rows and columns from user accept that much elements from user and display Matrix and print sum of even elements and sum of odd elements
*/
